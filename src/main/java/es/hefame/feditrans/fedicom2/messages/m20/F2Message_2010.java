 ...
 *
 */
public class F2Message_2010 extends F2Message{
	...
	public F2Message_2010(String data, int version) {
		super(data, version, MessageType.CABECERA_RESPUESTA);
	...
	public String toString() {
		return "CABECERA_RESP [codCli=<" + codCli + ">, numPedCli=<" + numPedCli + ">, rechazoPedido=<" + rechazoPedido
