 ...
 *
 */
public class F2Message_2015 extends F2Message{
	...
	public F2Message_2015(String data, int version) {
		super(data, version, MessageType.LINEA_INCIDENC);
	...
	public String toString() {
		return "LINEA_INCIDENC [codigoArti=" + codigoArti + ", cantidadPedida=" + cantidadPedida + ", cantidadFalta="
