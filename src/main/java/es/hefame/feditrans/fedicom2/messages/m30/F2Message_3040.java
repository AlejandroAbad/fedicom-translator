...
public class F2Message_3040 extends F2Message {

	protected String codArti;
	protected String cantidad;
	
	protected String descuento;
	protected String vale;
	...
	public F2Message_3040(String data, int version) {
		super(data, version, MessageType.LINEA_ABONO_ESTUPEF);
		...
		vale = data.substring(idx, idx += 25);
	...
	public String toString() {
		return super.toString() + " [codArti=<" + codArti + ">, cantidad=<" + cantidad + ">, descuento=<"+descuento+">, vale=<"+vale+"> lote=<" + lote
